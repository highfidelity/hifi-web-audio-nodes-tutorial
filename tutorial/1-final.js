...
async function findMostSimilarSound(caption,label) {
    ...
    for (const soundName of normalizedSoundNames) {
        ...
        try {
            ...
            const combinedScore = (scoreCaption * 0.1 + scoreLabel * 0.9);
        ...
        reader.onload = async function (e2) {
            try {
                ...
                image.onload = async function () {
                    ...
                    const generalSound = await findMostSimilarSound(generalCaption, "");
                    ...
                    for (let i = 0; i < objects.length && objectCount < maxObjects; i++) {
                        ...
                        console.log(`Object ${i + 1}: X: ${x.toFixed(2)}, Y: ${y.toFixed(2)}, Z: ${z}, Caption: ${captionText}`);
